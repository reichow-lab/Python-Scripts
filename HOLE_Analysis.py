...
sns.lineplot(data=PoreTimeDF, x="Time (ns)", y="Upper Radii (Å)",label='Upper Half',legend=False, palette=sns.color_palette('Reds_r', n_colors=1))
sns.lineplot(data=PoreTimeDF, x="Time (ns)", y="Lower Radii (Å)",label='Lower Half',legend=False, palette=sns.color_palette('Blues_r', n_colors=1))
plt.legend()
