...
n, bins, patches	=	ax1.hist(y, num_bins, density=1, facecolor=pdf_col, alpha=0.5)
...
n, bins, patches	=	ax2.hist(y, num_bins, density=1, histtype='step', color='black', alpha=0.5)

# Creating the cdf subplot
ax3	=	fig1.add_subplot(111, sharex=ax1, frameon=False)
ax3.hist(y, num_bins, density=1, color='navy', histtype='step', cumulative=True)
