...
plot_data = pd.DataFrame({"Pore-Axis (A)":Final[0], "PMF (Kcal/mol)": Final[1], "Potential (Kcal/mol)": Final[2], "Potential Diff. (Kcal/mol)": Final[3]})
plt.xlim(-85,85)
plt.ylim(-0.5,3)
...
#plt.xlabel("Pore Axis (A)")
#plt.ylabel('Energy (Kcal/mol)')
sns.lineplot(data=plot_data, x="Pore-Axis (A)", y="Potential (Kcal/mol)", hue=Final[4], style=Final[4])
...
#plt.xlabel("Pore Axis (A)")
#plt.ylabel('Energy (Kcal/mol)')
sns.lineplot(data=plot_data, x="Pore-Axis (A)", y="Potential Diff. (Kcal/mol)", hue=Final[4], style=Final[4])
