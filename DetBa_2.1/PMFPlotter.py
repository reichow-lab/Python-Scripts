...
def PMFPlotter(system,outname,pal):
    ...
    sns.lineplot(data=PMFPot, x="Pore-Axis (A)", y="Energy (Kcal/mol)", hue=Final[4], style=Final[4], palette=palette)
    plt.savefig(outname+"_PssPMF.png", transparent=True, dpi=400)
    plt.clf()
    plt.xlim(-85,85)
    plt.ylim(-2,5)
    ...
    plt.xlabel("Pore Axis (A)")
    plt.ylabel('Energy (Kcal/mol)')
    sns.lineplot(data=DrivePot, x="Pore-Axis (A)", y="Energy (Kcal/mol)", hue=Final[4], style=Final[4], palette=palette)
    ...
    plt.xlabel("Pore Axis (A)")
    plt.ylabel('Energy (Kcal/mol)')
    sns.lineplot(data=DiffPot, x="Pore-Axis (A)", y="Energy (Kcal/mol)", hue=Final[4], style=Final[4], palette=palette)
