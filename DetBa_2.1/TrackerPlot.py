...
sns.lineplot(data=plot_data2, x="Time (ns)", y="current (pA)", hue=WinAvg[3], palette=sns.color_palette(palette))
...
sns.distplot(data=fptList,kde='False',fit='norm',palette=sns.color_palette(palette))
