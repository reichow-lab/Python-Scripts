...
sns.lineplot(data=plot_data2, x="Time (ns)", y="current (pA)", hue=WinAvg[2], style=WinAvg[2], palette=sns.color_palette(palette, n_colors=4))#, edgecolor="none")
...
sns.lineplot(data=plot_data1, x="Time (ns)", y="Ion Permeations", hue=Final[3])#, edgecolor="none")
...
sns.lineplot(data=plot_data3, x="Time (ns)", y="<current> (pA)", hue=Final[3])
