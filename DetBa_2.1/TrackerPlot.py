...
sns.lineplot(data=plot_data2, x="Time (ns)", y="current (pA)", hue=WinAvg[2], palette=sns.color_palette(palette, n_colors=len(FileList)))
...
sns.lineplot(data=plot_data1, x="Time (ns)", y="Ion Permeations", hue=Final[3], label=Final[2], palette=sns.color_palette(palette, n_colors=len(FileList)))
