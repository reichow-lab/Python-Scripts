...
sns.scatterplot(data=plot_data1, x="Time (ns)", y="<current> (pA)", hue=Final[2], edgecolor="none")
...
sns.scatterplot(data=plot_data2, x="Time (ns)", y="Ion Permeations", hue=Final[2], edgecolor="none")
