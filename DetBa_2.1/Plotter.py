...
def WatFluxTrack(system,outname,palette,WS,LT,d_col,watlim):
    ...
    for FILE, label in zip(FileList, labels):
        ...
        sns.scatterplot(data=CumPermeations, x="Time (ns)", y="Cumulative Permeations", hue="Pore Height")
        ...
        sns.scatterplot(data=CumAverage, x="Time (ns)", y="Cumulative Average", hue="Pore Height")
