	...
	###############################################################################################################################################################################################
		...
		def Order_Assign(bin_now):
			...
			if self.first == "MT":
				...
				if self.first == bin_now:

					if self.second == "MT" and self.third == "MT" and self.fourth == "MT":
				...
				elif self.first != bin_now and self.second == "MT":
		...
		def Perm_Check(bin_now):
			...
			#elif	self.first == "BsA" and self.second == "BsB" and self.third == "Pc" and self.fourth == "BsA":
			...
			#elif	self.first == "BsB" and self.second == "BsA" and self.third == "Pc" and self.fourth == "BsB":
			...
			#elif	self.first == "Pc" and self.second == "BsA" and self.third == "BsB" and self.fourth == "Pc":
			...
			#elif	self.first == "Pc" and self.second == "BsB" and self.third == "BsA" and self.fourth == "Pc":
